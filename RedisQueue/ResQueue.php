...
class ResQueue
{
    ...
    /**
     * @var ResQueue_Redis Instance of ResQueue_Redis that talks to redis.
     */
    public static $redis = null;

    /**
     * @var null Host/port conbination separated by a colon, or a nested
     */
     ...
     * the redis server that ResQueue will talk to.
     *
    ...
    /**
     * Return an instance of the ResQueue_Redis class instantiated for Resque.
     *
     * @return ResQueue_Redis Instance of ResQueue_Redis.
     */
